...
const Register = () => {
    ...
    return (
        <div className="container mx-auto mb-24 lg:mb-32">
            <div className="text-neutral-900 font-semibold text-3xl justify-center flex items-center my-20 ">Register</div>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <div className="grid gap-1 text-center">
                            ...
                            <div className="text-sm">  Already have an account? <Link className="text-green-600" href='/login'>Sign in</Link></div>
                        </div>
                    </form>
                </Form>
            </div>
