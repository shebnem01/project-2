    ...
    return (
        <Link href='/product-detail' className="block mx-auto product-card w-[290px]">
            <div className="rounded-3xl relative bg-gray-200 mb-4 w-[290px] h-[320px]">
                <Image src='/8.webp' fill className="mx-auto" alt="product" />
            ...
            <div>
                ...
                <div className="text-normal text-gray-600 mb-2">product cat</div>
                <div className="flex justify-between items-center">
                    <div className="border-2 border-green-500 text-green-500 rounded-lg py-1 px-2 text-sm font-medium">$45</div>
